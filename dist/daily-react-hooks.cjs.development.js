...
var DailyIframe = _interopDefault(require('@daily-co/daily-js'));
...
var DailyProvider = function DailyProvider(_ref) {
  ...
  var _useState = React.useState('callObject' in props ? props.callObject : null),
  ...
  }, React__default.createElement(DailyRoom, null, React__default.createElement(DailyParticipants, null, children)))));
};
...
var useParticipant = function useParticipant(sessionId, _temp) {
  ...
  useThrottledDailyEvent('participant-updated', React.useCallback(function (evts) {
  ...
  useThrottledDailyEvent('participant-left', React.useCallback(function (evts) {
    var filteredEvts = evts.filter(function (ev) {
      return ev.participant.session_id === sessionId;
    });
...
var mediaTrackState = /*#__PURE__*/recoil.atomFamily({
  key: 'media-track',
  "default": {
    state: 'loading',
    subscribed: false
...
var useMediaTrack = function useMediaTrack(participantId, type) {
  ...
  var trackState = recoil.useRecoilValue(mediaTrackState(key));
  var handleNewParticipantState = recoil.useRecoilCallback(function (_ref) {
  ...
  useDailyEvent('joined-meeting', recoil.useRecoilCallback(function (_ref3) {
    var set = _ref3.set;
    return function (ev) {
      set(mediaTrackState(key), ev.participants.local.tracks[type]);
    };
  }, [key, type]));
  var setInitialState = recoil.useRecoilCallback(function (_ref4) {
    var set = _ref4.set;
...
var useDevices = function useDevices() {
  ...
  var refreshDevices = recoil.useRecoilCallback(function (_ref) {
    var transact_UNSTABLE = _ref.transact_UNSTABLE;
    return /*#__PURE__*/_asyncToGenerator(function* () {
  ...
  var updateDeviceStates = recoil.useRecoilCallback(function (_ref6) {
    var set = _ref6.set,
  ...
  useDailyEvent('camera-error', recoil.useRecoilCallback(function (_ref12) {
    var set = _ref12.set,
  ...
  useDailyEvent('error', recoil.useRecoilCallback(function (_ref17) {
  ...
  useDailyEvent('started-camera', recoil.useRecoilCallback(function (_ref20) {
...
var useInputSettings = function useInputSettings(_temp) {
  ...
  var updateInputSettings = React.useCallback(function (inputSettings) {
...
var useLiveStreaming = function useLiveStreaming(_temp) {
  ...
  var startLiveStreaming = React.useCallback(function (options) {
    if (!daily) return;
  ...
  var updateLiveStreaming = React.useCallback(function (_ref5) {
...
var useNetwork = function useNetwork(_temp) {
  ...
  var handleNetworkConnection = recoil.useRecoilCallback(function (_ref2) {
  ...
  var handleNetworkQualityChange = recoil.useRecoilCallback(function (_ref4) {
...
var useParticipantIds = function useParticipantIds(_temp) {
  ...
  useThrottledDailyEvent('participant-joined', React.useCallback(function (evts) {
    if (!evts.length) return;
  ...
  useThrottledDailyEvent('active-speaker-change', React.useCallback( /*#__PURE__*/function () {
...
var useParticipantProperty = function useParticipantProperty(participantId, propertyPath) {
  return recoil.useRecoilValue(participantPropertyState({
    id: participantId,
...
var useReceiveSettings = function useReceiveSettings(_temp) {
  ...
  var updateReceiveSettings = React.useCallback(function (receiveSettings) {
...
var useRecording = function useRecording(_temp) {
  ...
  var startRecording = React.useCallback(function (options) {
    if (!daily) return;
  ...
  var updateRecording = React.useCallback(function (options) {
    if (!daily) return;
...
var useScreenShare = function useScreenShare(_temp) {
  ...
  var daily = useDaily();
  var startScreenShare = React.useCallback(function (captureOptions) {
...
//# sourceMappingURL=daily-react-hooks.cjs.development.js.map
